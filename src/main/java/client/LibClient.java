...
public class LibClient implements Runnable {
    ...
    public LibClient(BufferedReader streamIn, BufferedWriter streamOut, BufferedReader console) {
    ...
    public void start() throws IOException {
        if (thread == null) {
            client = new ClientThread(this, streamIn);
    ...
    public void start(Socket s) throws IOException {
        try {
            ...
            streamIn = new BufferedReader(new InputStreamReader(s.getInputStream()));
            streamOut = new BufferedWriter(new OutputStreamWriter(s.getOutputStream()));
