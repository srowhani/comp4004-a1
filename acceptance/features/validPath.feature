Feature: Valid Paths
  ...
  Scenario: Borrow
    ...
    And User "u1" returns copy 2 of "2222222222222"

    And User "u2" returns copy 1 of "1111111111111"
    And User "u2" returns copy 1 of "2222222222222"

    And User "u1" borrows copy 0 of "1111111111111"
    Then System outputs "Success!"
    When User "u1" borrows copy 2 of "2222222222222"
    Then System outputs "Success!"

  Scenario: Renew when full
    Given User "u1" created
    And Title "t1" with ISBN "1111111111111" exists
    And Title "t2" with ISBN "2222222222222" exists
    ...
    When User "u1" borrows copy 0 of "1111111111111"
    And User "u1" borrows copy 1 of "2222222222222"

    And User "u1" renews copy 0 of "1111111111111"
    Then System outputs "Success!"
    When User "u1" renews copy 1 of "2222222222222"
    Then System outputs "Success!"
